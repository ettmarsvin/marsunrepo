...
\newcommand{\SUBTITLE}{}
\newcommand{\FSUBTITLE}{}
\newcommand{\DATE}{December 24, 2014}
\newcommand{\FDATE}{24. joulukuuta 2014}
...
\newcommand{\INSTRUCTOR}{Satu Rekonen, LicSc (Tech.) and MSc (Econ.)}
\newcommand{\FINSTRUCTOR}{LicSc (Tech.) and MSc (Econ.) Satu Rekonen}
...
\newcommand{\KEYWORDS}{Organisational behaviour, learning, creativity, experimentation-driven development}
\newcommand{\FKEYWORDS}{Organisaatiokäyttäytyminen, oppiminen, luovuus, kokeilemalla kehittäminen}
