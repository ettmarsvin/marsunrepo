...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Factors affecting experimentation-driven innovation and learning in an organisation}
\newcommand{\FTITLE}{Otsikko suomeksi}
\newcommand{\SUBTITLE}{}
\newcommand{\FSUBTITLE}{}
\newcommand{\DATE}{January 1, 2015}
...
\newcommand{\INSTRUCTOR}{Satu Rekonen, <Titteli>}
\newcommand{\FINSTRUCTOR}{<Titteli> Satu Rekonen}
...
\newcommand{\KEYWORDS}{Keywords go here}
\newcommand{\FKEYWORDS}{Avainsanoja tahan}
