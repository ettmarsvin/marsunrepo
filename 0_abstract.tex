...
To study the factors affecting experimentation behaviour, an interpretive approach together with thematic analysis was used. The data consisted on 14 semi-structured interviews. 

This study demonstrates how experimentation-driven development can be applied in organisational environment as a way to foster organisational learning and development. As a result from this study, factors affecting experimentation behaviour in an organisation are presented. Additionally, light is shed on on how experience of experimenting affects on individual. Furthermore, the findings of the research form a synthesis of a supporting environment for experimentation-driven development. 
