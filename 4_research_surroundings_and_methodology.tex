...
information of experimentation challenge to their units. Researchers gave very brief introduction poster on experimentation and instructions for the challenge, further instructions during the challenge were not provided. The introduction poster can be found in appendix \ref{introposter}. 
...
\subsubsection*{1. Transcribing of interviews and overview of the interview notes}
...
\subsubsection*{2. Coding of the interviews}
...
\subsubsection*{3. Initial categorisation}
Together with two researchers initial categorising under themes that seemed most appropriate was made. Both factors affecting experimentation and the experience of experimentation were recognised and were taken into account in categorisation process. The initial categorisation can be seen in the table \ref{tbl:initialcategories}.
...
\subsubsection*{4. Theme creation and category refinement}
...
\subsubsection*{5. Refinement of final themes and categories}
