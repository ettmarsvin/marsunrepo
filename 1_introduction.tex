...
Chapters \ref{learning}, \ref{expo} and \ref{faetheory} form the theoretical basis for the thesis, and chapter \ref{researchdesign} with chapter \ref{results} present the empirical part of the thesis. 
